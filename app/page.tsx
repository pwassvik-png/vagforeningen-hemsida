    ...
    <div className="min-h-screen bg-surface">
      ...
      <header className="bg-primary text-white">
        <div className="max-w-[1200px] mx-auto px-5 sm:px-6 py-14 sm:py-20 md:py-28 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center">
            <Link
              href="/login"
              className="bg-secondary text-white px-8 py-3 rounded-[10px] font-semibold text-base hover:brightness-110 transition text-center"
            >
              Logga in
            </Link>
            <Link
      ...
      <main className="max-w-[1200px] mx-auto px-4 sm:px-6 py-12 sm:py-16 md:py-20">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6">
          <Link href="/dashboard/news" className="bg-white rounded-2xl p-5 sm:p-6 border border-outline-variant shadow-sm hover:shadow-md transition group">
            <div className="w-11 h-11 sm:w-12 sm:h-12 rounded-xl bg-secondary/10 flex items-center justify-center text-xl sm:text-2xl mb-3 sm:mb-4">
              📰
            </div>
          ...
          <Link href="/dashboard/issues" className="bg-white rounded-2xl p-5 sm:p-6 border border-outline-variant shadow-sm hover:shadow-md transition group">
            <div className="w-11 h-11 sm:w-12 sm:h-12 rounded-xl bg-secondary/10 flex items-center justify-center text-xl sm:text-2xl mb-3 sm:mb-4">
              🐛
            </div>
          ...
          <Link href="/dashboard/documents" className="bg-white rounded-2xl p-5 sm:p-6 border border-outline-variant shadow-sm hover:shadow-md transition group">
            <div className="w-11 h-11 sm:w-12 sm:h-12 rounded-xl bg-secondary/10 flex items-center justify-center text-xl sm:text-2xl mb-3 sm:mb-4">
              📄
            </div>
        ...
        {/* About Section */}
        <div className="mt-12 sm:mt-16 md:mt-20 bg-white rounded-2xl p-6 sm:p-8 md:p-10 border border-outline-variant shadow-sm">
          <h2 className="text-2xl sm:text-3xl font-semibold mb-6 sm:mb-8">Om föreningen</h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 sm:gap-10">
            <div>
              <h3 className="font-semibold text-secondary text-base sm:text-lg mb-2 sm:mb-3">Kontakt</h3>
              <div className="space-y-1.5 sm:space-y-2 text-on-surface-variant leading-relaxed text-sm sm:text-base">
            ...
            <div>
              <h3 className="font-semibold text-secondary text-base sm:text-lg mb-2 sm:mb-3">Fakta</h3>
              <div className="space-y-1.5 sm:space-y-2 text-on-surface-variant leading-relaxed text-sm sm:text-base">
      ...
      {/* Footer */}
      <footer className="bg-inverse-surface text-white/70 py-6 sm:py-8 pb-20 sm:pb-8">
